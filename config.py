# --- Load profile ---
LOAD_CSV = "industrial_load.csv"  # path to normalized load profile

# --- Technical constants ---
PSUC_BAR       = 20.0            # Suction pressure (bar)
PDISC_BAR      = 70.0            # Discharge pressure (bar)
x              = 2.23             # pressure ratio per stage
NUMBER_OF_STAGES = 2
PER_STAGE_PR   = 2.234 
...
REF_RPM        = 3600           # Reference compressor speed (rpm)
...
COST_FROM_HDSAM_USD = 1962.2       # Base cost (2007 USD)
SCALING_EXPONENT    = 0.8225       # Size exponent for cost correlation
