...
def calculate_pipeline_economics(
    ...
    # True annual throughput from CSV
    ...
    print(annual_mass_kg)

    # Compute annual electricity costs
    ...
    return {'fixed_speed': {'inlet': inlet_fixed, 'enroute': enroute_fixed, 'total': total_fixed},
